<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty_side/Faculty_Master.Master" AutoEventWireup="true" CodeBehind="Topic_Edit.aspx.cs" Inherits="TeachEasy.Faculty_side.TopicEdit" %>
    ...
    <div class="main-content" style="min-width: 1349px;">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Edit Topic</h2>
                <p class="section-lead">
                    On this page you can edit topic.
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <asp:DropDownList ID="DrDoL_Subject" runat="server" CssClass="form-control selectric" DataSourceID="SDS_Subject" DataTextField="Subject_Name" DataValueField="Subject_ID" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="DrDoL_Subject_SelectedIndexChanged">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <asp:DropDownList ID="DrDoL_Unit" runat="server" CssClass="form-control selectric" DataSourceID="SDS_Unit" DataTextField="Unit_Name" DataValueField="Unit_Id" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="DrDoL_Unit_SelectedIndexChanged">
                                            <asp:ListItem Value="NULL">--Select--</asp:ListItem>
                                        </asp:DropDownList>
