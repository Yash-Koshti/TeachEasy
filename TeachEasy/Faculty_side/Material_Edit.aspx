<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty_side/Faculty_Master.Master" AutoEventWireup="true" CodeBehind="Material_Edit.aspx.cs" Inherits="TeachEasy.Faculty_side.MaterialEdit" %>
        ...
        <section class="section">
          ...
          <div class="section-body">
            ...
            <p class="section-lead">
              On this page you can edit a material.
            </p>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <asp:DropDownList ID="DrDoL_M_Type" runat="server" CssClass="form-control selectric" AutoPostBack="True">
                          ...
                          <asp:RequiredFieldValidator ID="ReqFVal_DrDoL_M_Type" runat="server" ErrorMessage="*Please select material type" ControlToValidate="DrDoL_M_Type" SetFocusOnError="True"></asp:RequiredFieldValidator>
                      </div>
                    </div>
                    <div class="form-group row mb-4">
                          <div class="row">
