<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty_side/Faculty_Master.Master" AutoEventWireup="true" CodeBehind="Chapter_Add.aspx.cs" Inherits="TeachEasy.Faculty_side.ChapterAdd" %>
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Add New Chapter</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Add New Chapter</h2>
                <p class="section-lead">
                    On this page you can add a new chapter and fill in all fields.
