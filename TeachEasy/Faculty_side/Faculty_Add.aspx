<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faculty_Add.aspx.cs" Inherits="TeachEasy.Faculty_side.Faculty_Add" %>
        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
              ...
              <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                  <li class="nav-item">
                    <a class="nav-link" href="Manage_Faculty.aspx">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse down-usr-page1" id="auth">
                      <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="Manage_Faculty.aspx"> Faculty </a></li>
                        <li class="nav-item"> <a class="nav-link" href="../Student_side/Manage_Student.aspx"> Student </a></li>
              ...
              <div class="main-panel">
                <div class="content-wrapper">
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Add Faculty Details</h4>
