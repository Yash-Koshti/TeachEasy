    ...
    public partial class ManageSubject : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Admin_id"] != null)
            {
                ...
                //SqlDataAdapter adp = new SqlDataAdapter("SELECT * FROM Subjectview", con);
                //DataSet ds = new DataSet();
                //adp.Fill(ds, "Subject");

                //GridView1.DataSource = ds.Tables["Subject"];
                //GridView1.DataBind();
            }
            else
            {
        ...
        {
            Response.Redirect("~/Admin_side/Subject_Edit.aspx?id=" + GridView1.SelectedRow.Cells[1].Text);
        }

        protected void Add_btn_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Admin_side/Subject_Add.aspx");
        }
    }
}