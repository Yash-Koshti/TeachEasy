<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_side/Admin_Master.Master" AutoEventWireup="true" CodeBehind="Student_Add.aspx.cs" Inherits="TeachEasy.Admin_side.Student_Add" %>
        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="Manage_Student.aspx" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
                </div>
                <h1>Add New Student</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="Manage_Faculty.aspx">Home</a></div>
                    <div class="breadcrumb-item"><a href="Manage_Student.aspx">Student</a></div>
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    On this page you can add a new student and fill in all fields.
