...
namespace TeachEasy.Student_side
{
    public partial class Video : System.Web.UI.Page
    {
        ...
        protected void DrDoL_Subject_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SDS_DL_Videos.SelectCommand = "SELECT * FROM Material WHERE M_Type='Video' AND Subject_Id=" + DrDoL_Subject.SelectedValue.ToString();
            SDS_DL_Videos.DataBind();
            DL_Videos.DataBind();
        }
        ...
        protected void DrDoL_Unit_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DrDoL_Subject.SelectedValue != "NULL")
            {
                ...
                SDS_DL_Videos.SelectCommand = "SELECT * FROM Material WHERE M_Type='Video' AND Subject_Id=" + DrDoL_Subject.SelectedValue.ToString() + " AND Unit_Id=" + DrDoL_Unit.SelectedValue.ToString();
                SDS_DL_Videos.DataBind();
                DL_Videos.DataBind();
            }
            else
        ...
        protected void DrDoL_Chapter_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SDS_DL_Videos.SelectCommand = "SELECT * FROM Material WHERE M_Type='Video' AND Ch_Id=" + DrDoL_Chapter.SelectedValue.ToString();
            SDS_DL_Videos.DataBind();
            DL_Videos.DataBind();
        }
        ...
        {
            SDS_DL_Videos.SelectCommand = "SELECT * FROM Material WHERE M_Type='Video' AND Topic_Id=" + DrDoL_Topic.SelectedValue.ToString();
            SDS_DL_Videos.DataBind();
            DL_Videos.DataBind();
        }
    }
