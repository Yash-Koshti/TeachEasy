<%@ Page Title="" Language="C#" MasterPageFile="~/Student_side/Student_Master.Master" AutoEventWireup="true" CodeBehind="Student_Edit.aspx.cs" Inherits="TeachEasy.Student_side.StudentEdit" %>
    ...
    <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Hi, <%Response.Write(Session["S_name"]); %>!</h2>
                  ...
                  <div class="profile-widget-header">
                    ...
                    <div class="profile-widget-items">
                      <div class="profile-widget-item">
                        <div class="profile-widget-item-label">Attendace</div>
                        <div class="profile-widget-item-value">187</div>
                      </div>
                      <div class="profile-widget-item">
                        <div class="profile-widget-item-label">Exams</div>
                        <div class="profile-widget-item-value">2,1K</div>
                      </div>
                    </div>
                  </div>
                  <div class="profile-widget-description">
                    <div class="profile-widget-name"><%Response.Write(Session["S_name"]); %> <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> SEM-<%Response.Write(Session["Sem_Id"]); %> <div class="slash"></div> <%Response.Write(DateTime.Parse(Session["Admission_Date"].ToString()).ToShortDateString()); %></div></div>
                    ...
                    <div class="card-body">
                        <div class="row">                               
                          ...
                          <div class="form-group col-md-6 col-12">
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <asp:RadioButtonList ID="RaBuL_Gender" runat="server" CssClass="form-check-input" RepeatColumns="3" CellSpacing="-1" CellPadding="7">
                        ...
                        <div class="row">
                          <div class="form-group col-md-5 col-12">
                            ...
                            <div class="form-group col-md-6 col-12 offset-1">
